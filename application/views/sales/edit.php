        ...
        <div class="card-body">
            ...
            <form method="post">
                <?php foreach ($sales as $data) : ?>
                    ...
                    <a href="<?= base_url('sales/pdf/') . $data['soid']; ?>" class="btn btn-danger" role="button" target="_blank"><i class="fa fa-print"></i> Print</a>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col">
                            <label for="soid" class="col-form-label">Sales No</label>
                            <input type="text" class="form-control" id="soid" name="soid" value="<?= $data['soid']; ?>" readonly>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control" id="nopol" name="nopol" value="<?= $data['nopol']; ?>">
                        ...
                        <?php foreach ($salesdetail as $data) : ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?= base_url('sales/') . 'deldetail/' . $data['soid'] . '/' . $data['itemsid']; ?>" id="<?= $data['itemsid']; ?>" name="delete" class="btn btn-sm btn-danger">del</a>
                                </td>
                            </tr>
            ...
            <form method="post" id="insertform">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group" hidden>
                        <label for="soid1" class="col-form-label">soid:</label>
                        <input type="text" class="form-control" id="soid1" name="soid1" value="<?= $data['soid']; ?>">
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#insertform').on('submit', function(event) {
            ...
            if ($('#soid1').val() == '') {
                alert('soid tidak boleh kosong');
            } else if ($('#itemsid') == '') {
                alert('Items Id tidak boleh kosong');
            } else {
                $.ajax({
                    url: "<?= base_url('sales/adddetail') ?>",
                    method: "post",
